...
//import com.kco.demo.ai.bean.DetectFaceBean;
//import com.kco.demo.ai.bean.ImageBean;
//import com.kco.demo.ai.bean.ResultBean;
//import com.kco.demo.ai.bean.TextchatBean;
...
// */
//public final class TencentAiTools {
...
//        for (int i = 8; i <= 50; i ++){
//            ptuFacemerge(new File("C:\\Users\\666666\\Desktop\\test1\\psb (17).jpg"),  i);
//            try {
//                Thread.sleep(500);
...
//     */
//    public static ResultBean<ImageBean> ptuFacecosmetic(File imageFile, int cosmetic) {
...
//        File outFile = new File(imageFile.getParent() +"\\out","out-" + cosmetic + "-" + imageFile.getName());
...
//     * http://ai.qq.com/doc/ptuimgfilter.shtml
//     */
//    public static ResultBean<ImageBean> ptuImgfilter(File imageFile, int filter) {
...
//        map.put("sign", sign(map, appKey));
//        ResultBean<ImageBean> resultBean = httpPost(baseUrl, map, ImageBean.class);
//        File outFile = new File(imageFile.getParent() +"\\out","out-" + filter + "-" + imageFile.getName());
//        Base64ToFile(resultBean.getData().getImage(), outFile);
//        return resultBean;
//    }
//    /**
...
//     * http://ai.qq.com/doc/ptuimgfilter.shtml
//     */
//    public static ResultBean<ImageBean> visionImgfilter(File imageFile, int filter) {
...
//     */
//    public static ResultBean<ImageBean> ptuFacesticker(File imageFile, int sticker) {
...
//        map.put("sign", sign(map, appKey));
//        ResultBean<ImageBean> resultBean = httpPost(baseUrl, map, ImageBean.class);
//        File outFile = new File(imageFile.getParent() +"\\out","out-" + sticker + "-" + imageFile.getName());
//        Base64ToFile(resultBean.getData().getImage(), outFile);
//        return resultBean;
//    }
//    /**
...
//     */
//    public static ResultBean<ImageBean> ptuFacemerge(File imageFile, int model){
...
//    }
//
//    private static byte[] Base64ToFile(String base64String, File outFile){
//        try {
